...
<body class="font-quicksand">
    <aside id="default-sidebar"
        class="fixed top-0 left-0 z-20 w-24 h-screen "
        aria-label="Sidebar">
    ...
    <div class="p-20 ml-24 bg-slate-50 mr-96  pt-9" >
        <div class="flex flex-row justify-between mb-10">
            <h1 class="text-2xl"><span class=" text-amber-500 font-bold">Shoppingify</span> allows you take your shopping list wherever you go</h1>
            <form>   
                ...
                <div class="relative">
                    ...
                    <input type="search" id="default-search" class="block w-48 p-4 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500    " placeholder="Search" required>
                </div>
            </form>
        </div>
        ...
        <div class="bg-white w-96 h-screen overflow-y-auto p-6">
            ...
            <form action="{{route('items.store')}}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <input name="name" type="text" id="default-input" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  ">
                </div>
                <div class="mb-6">
                    <label for="default-input" class="block mb-2 text-sm font-medium text-gray-900">Note(opcional)</label>
                    <input type="text" id="default-inpu" name="note" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  ">
                </div>
                <div class="mb-6">
                    <label for="default-input" class="block mb-2 text-sm font-medium text-gray-900">image(opcional)</label>
                    <input type="text" id="default-image" name="image" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  ">
                </div>
                <div class="mb-6">
                    <label for="categories" class="block mb-2 text-sm font-medium text-gray-900">Selecciona una categoria</label>
                    <select id="categories" name="category" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                       @foreach ($categories as $category)
            ...
            <button id="closeModal" class="mt-4 bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded">
                Cancel
            </button>
            <button type="submit" id="closeModal1" class="mt-4 bg-sky-600 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded">
                Save
            </button>
        </form>
        </div>
    ...
    <aside id="default-sidebar"
        class="fixed top-0 right-0 z-20 w-96 h-screen bg-red-100 "
        aria-label="Sidebar">
                ...
                <form>
                    <div class="flex">
                        <div class="relative w-full">
                            <input type="text" class="block p-2.5 w-full h-16 z-20 text-sm  rounded-lg border-amber-500 border-2" placeholder="Enter a name" required>
                            <button type="submit" class="absolute top-0 right-0 p-2.5 h-full text-sm font-medium text-white bg-amber-500 rounded-lg hover:bg-amber-400 ">
                                Save
                            </button>
                        </div>
                    </div>
